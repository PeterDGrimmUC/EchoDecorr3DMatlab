classdef SerialClass
    ...
    methods
        ...
        function outs=parseOutput(obj,inputLine,tStamp)
            ...
            outs.t1 = EchoDecorrPkg.Utils.numto14(inputLine(21),inputLine(22))/10;
            outs.t2 = EchoDecorrPkg.Utils.numto14(inputLine(23),inputLine(24))/10;
            outs.t3 = EchoDecorrPkg.Utils.numto14(inputLine(25),inputLine(26))/10;
            outs.t4 = EchoDecorrPkg.Utils.numto14(inputLine(27),inputLine(28))/10;
            if outs.t1 > 150
            ...
            outs.targetPower = EchoDecorrPkg.Utils.numto14(inputLine(11),inputLine(12))/10;
            outs.currentPower = EchoDecorrPkg.Utils.numto14(inputLine(15),inputLine(16))/10;
            outs.targetTemp = EchoDecorrPkg.Utils.numto14(inputLine(39),inputLine(40))/10;
            outs.impedance = EchoDecorrPkg.Utils.numto14(inputLine(19),inputLine(20))/10;
