...
classdef USDataClass2D < handle 
    ...
    methods
        %% Constructor method
        function obj = USDataClass2D(thisRawData,startTime,thisInfoFile,thisrmin,thisrmax,thisthetamin,thisthetamax,thisphimin,thisphimax,thiscartScalingFactor,thiswindowSigma,thisinterFrameTime,mode)
